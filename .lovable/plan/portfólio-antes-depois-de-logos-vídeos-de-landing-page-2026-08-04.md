# Portfólio: antes/depois de logos + vídeos de landing page

Duas adições na seção `#portfolio`, nesta ordem: primeiro o **Antes e depois** de logos, depois os **vídeos de landing page**. Sem criar tokens/classes novas — tudo usa o design system atual (vermelho neon, painéis de vidro, Reveal, TiltCard).

## 1. Antes e Depois de logos

Bloco novo logo abaixo dos grids de Instagram, com título "Antes e depois" e um comparador arrastável:
...
## 2. Landing Pages em vídeo

Logo em seguida, com abas no topo do portfólio alternando o conteúdo:
...
- Novos arquivos: `src/components/ds/BeforeAfter.tsx`, `src/components/sections/LogoBeforeAfter.tsx`, `src/components/ds/BrowserFrame.tsx`, `src/components/sections/LandingPagesShowcase.tsx`.
...
- Assets (imagens de logo e vídeos) vão para o CDN via Lovable Assets, com pointers `.asset.json`.
